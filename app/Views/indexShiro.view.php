    ...
    <section class="col-12">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 mt-1">
            ...
            <div class="col">
                <div class="card h-100">
                    <a href="/shironime/animecompleto?idAnime=<?php echo $animesMostrar[$i + 1]['id_serie'] ?>"><img src="<?php echo $animesMostrar[$i + 1]['rutaPortada'] ?>" class="card-img-top" alt="Imagen portada del anime <?php echo $animesMostrar[$i + 1]['nombre'] ?>"></a>
                    <div class="card-body overflow-hidden">
            ...
            <div class="col">
                <div class="card h-100">
                    <a href="/shironime/animecompleto?idAnime=<?php echo $animesMostrar[$i + 2]['id_serie'] ?>"><img src="<?php echo $animesMostrar[$i + 2]['rutaPortada'] ?>" class="card-img-top" alt="Imagen portada del anime <?php echo $animesMostrar[$i + 2]['nombre'] ?>"></a>
                    <div class="card-body overflow-hidden">
